            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
                ...
                <section class="lg:col-span-8">
                    @if ($posts->count() > 0 || $pages->count() > 0)
                        ...
                        @if ($posts->count() > 0)
                            <h2
                                class="font-headline-md text-headline-md mb-gutter uppercase border-l-8 border-crimson-red pl-4">
                            ...
                            @foreach ($posts as $post)
                                <article
                                    ...
                                    <div class="p-stack-md flex-grow">
                                        ...
                                        @endif
                                        <h3 class="font-headline-md text-[22px] text-charcoal mb-stack-sm leading-tight">
                                            <a href="{{ route('posts.show', $post->slug) }}"
                                                class="hover:text-crimson-red transition-colors">{{ $post->title }}</a>
                                        </h3>
                                        <p class="font-body-md text-secondary line-clamp-2">
                        ...
                        @if ($pages->count() > 0)
                            <h2
                                class="font-headline-md text-headline-md mb-gutter uppercase border-l-8 border-crimson-red pl-4 mt-section-padding">
                            ...
                            @foreach ($pages as $page)
                                <article
                                    ...
                                    <h3 class="font-headline-md text-[22px] text-charcoal mb-stack-sm">
                    ...
                    @else
                        <div class="bg-white border border-charcoal/10 p-section-padding text-center shadow-sm">
                            ...
                            <h3 class="font-headline-md text-headline-md text-charcoal mb-stack-md">Tidak ada hasil
                            </h3>

                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="3">{{ old('address', $coach->address) }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                        <option value="active" {{ old('status', $coach->status) == 'active' ? 'selected' : '' }}>Aktif</option>
                                        <option value="inactive" {{ old('status', $coach->status) == 'inactive' ? 'selected' : '' }}>Tidak Aktif</option>
                                    </select>

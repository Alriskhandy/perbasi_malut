@extends('backend.layouts.main', ['title' => 'Edit Pelatih'])
    ...
    <div class="container">
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    <h3 class="fw-bold mb-3 fs-3">Edit Pelatih</h3>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @include('backend.partials._education_select', ['selectedEducation' => $coach->education])
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="contact" class="form-control @error('contact') is-invalid @enderror"
                                            value="{{ old('contact', $coach->contact) }}">
                                        @error('contact') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Alamat</label>
                                        <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="2">{{ old('address', $coach->address) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="id_number" class="form-control @error('id_number') is-invalid @enderror"
                                            value="{{ old('id_number', $coach->id_number) }}">
                                        ...
                                        <select name="team_id" class="form-select @error('team_id') is-invalid @enderror" required>
                                            ...
                                            @foreach ($teams as $team)
                                                <option value="{{ $team->id }}"
                                                    {{ old('team_id', $coach->team_id) == $team->id ? 'selected' : '' }}>
                                                    {{ $team->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="license" class="form-select @error('license') is-invalid @enderror">
                                            <option value="Non-Lisensi" {{ old('license', $coach->license ?? 'Non-Lisensi') == 'Non-Lisensi' ? 'selected' : '' }}>Non-Lisensi</option>
                                            <option value="LEVEL A" {{ old('license', $coach->license) == 'LEVEL A' ? 'selected' : '' }}>Level A</option>
                                            <option value="LEVEL B" {{ old('license', $coach->license) == 'LEVEL B' ? 'selected' : '' }}>Level B</option>
                                            <option value="LEVEL C" {{ old('license', $coach->license) == 'LEVEL C' ? 'selected' : '' }}>Level C</option>
                                            <option value="FIBA" {{ old('license', $coach->license) == 'FIBA' ? 'selected' : '' }}>FIBA</option>
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="license_number" class="form-control @error('license_number') is-invalid @enderror"
                                            value="{{ old('license_number', $coach->license_number) }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                        <option value="registered" {{ old('status', $coach->status) == 'registered' ? 'selected' : '' }}>Registered</option>
                                        <option value="not registered" {{ old('status', $coach->status) == 'not registered' ? 'selected' : '' }}>Not Registered</option>
                                    </select>
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" name="img_path" id="imgPath"
                                        ...
                                        value="{{ old('img_path', $coach->img_path) }}" placeholder="URL gambar" readonly>
                                ...
                                <img id="imgPreview" src="{{ \App\Helpers\Media::url(old('img_path', $coach->img_path)) }}"
                                    style="max-width:100%; display: {{ $coach->img_path ? 'block' : 'none' }}; margin-top:8px;">
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    @include('backend.partials._province_city_scripts', ['selectedProvince' => $coach->province, 'selectedCity' => $coach->city])
@endpush

                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="dpdName" class="form-control @error('name') is-invalid @enderror"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="slug" id="dpdSlug"
                                            class="form-control @error('slug') is-invalid @enderror"
                                            value="{{ old('slug') }}"
                                            placeholder="contoh: perbasi-ternate"
                                            pattern="[a-z0-9-]+"
...
@push('scripts')
    <script>
        ...
        const nameInput = document.getElementById('dpdName');
        const slugInput = document.getElementById('dpdSlug');
        let slugManuallyEdited = false;
        slugInput.addEventListener('input', () => { slugManuallyEdited = slugInput.value.length > 0; });
        nameInput.addEventListener('input', function () {
            if (!slugManuallyEdited) {
                slugInput.placeholder = this.value.toLowerCase().replace(/[^a-z0-9\s-]/g, '').trim().replace(/\s+/g, '-');
            }
        });
    </script>
@endpush
